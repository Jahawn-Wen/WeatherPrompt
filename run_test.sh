...
# python test_iaa.py \
# --name='three_view_long_share_d0.5_256_s1_google_lr0.005_spade_210ep_weather_0110000_fin' \
...
# python test.py \
# --name='three_view_long_share_d0.5_256_s1_google_lr0.001_spade_210ep_weather_0110000_fin'  \
# --test_dir='/home/wjh/project/MuseNet-master-test/dataset/University-Release/test' \
# --batchsize=128 \
# --gpu_ids='2'
...
--test_dir='/home/wjh/project/MuseNet-master-test-vit/dataset/University-Release/test' \
--batchsize=128 \
--iaa \
--use_swin \
--gpu_ids='3'
